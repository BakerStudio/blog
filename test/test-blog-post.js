...
describe('BlogPosts', function() {
  ...
  it('should add an item on POST', function() {
    const newItem = {'title': 'Overdosing on MOCHA and CHAI',
                    'content': 'Answers the eternal question, too much of a good thing or...?',
  ...
  it('should update items on PUT', function() {
    ...
    const updateData = {
      'author': 'Harry Homeowner',
      'title': 'The Most Interesting Man in the World',
      'content': 'You will be amazed by what this man can do...'
    };
  ...
  // test strategy:
  //  1. GET a blog list of items so we can get ID of one
  //  to delete.
